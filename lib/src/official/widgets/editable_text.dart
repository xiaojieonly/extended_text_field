...
class _EditableTextState extends State<_EditableText>
  ...
  /// Returns the [ContextMenuButtonItem]s representing the buttons in this
  /// platform's default selection menu for [_EditableText].
  ///
  /// See also:
  ///
...
class _Editable extends MultiChildRenderObjectWidget {
  ...
  // zmtzawqlp
  @override
  _RenderEditable createRenderObject(BuildContext context) {
...
class _ScribbleFocusableState extends State<_ScribbleFocusable>
  ...
  // zmtzawqlp
  _RenderEditable? get renderEditable =>
      widget.editableKey.currentContext?.findRenderObject() as _RenderEditable?;
...
class _DeleteTextAction<T extends DirectionalTextEditingIntent>
  ...
  /// zmtzawqlp
  final _EditableTextState state;
